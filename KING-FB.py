...
logo = (""" \n\n            \033[0;91m• \033[0;93m• \033[0;92m•\x1b[1;97m\x1b[1;41m Recoded by Younis John \x1b[0m\033[0;92m• \033[0;93m• \033[0;91m•\033[1;97m""")
class Main:
	def __init__(self):
		self.id = []
		self.cp = []
		...
		tamp_new = (f'{P2}Please Change Your Sim Network Before Cloning\n\n       {H2}Toll Modified By Younis John > 3')
		printer(Panel(tamp_new,title=f'{H2}[ {P2}Disclaimer!{H2} ]',width=54,padding=(1,4),style='#00FF00'))
		print("") 
		...
		if romii in ["8", "08"]:
				self.oldcrack()
		if romii in ["0", "00"]:
			jalan("\n\n\033[1;92m>Ocyy Bye See You again\n")
			time.sleep(3)
			exit()
		else:
	...
	def old_9(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				tamp_new = (f'{H2}Use Password: 123456{H2}')
	...
	def old4_6(self):
		...
		if (limit)>10000:
			exit("\n%s\033[0;91m•\033[0;97m Don't Cross The Limit Bro:)"%(R))
		try:
			for n in range(limit):
				_ = random.randint(x,xx)
				__ = idx
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s\033[0;91m[\033[0;97m?\033[0;91m] \033[0;97mType a Name%s\033[0;91m(\033[0;97mEx: Romii, Alina\033[0;91m):\033[0;97m "%(Y,G))
		nam = nam.replace(" ", "")
		print("%s\x1b[1;97m\x1b[1;41mExample\x1b[0m  - %s@gmail.com, @yahoo.com, @hotmail.com ETC"%(Y,G))
		idx = input("%sDomain  : "%(B))
